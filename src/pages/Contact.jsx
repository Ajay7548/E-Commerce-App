      ...
      <div className='mt-6 grid md:grid-cols-2 gap-10 py-10  '>
        ...
        <div className=''>
          <div className='flex flex-col '>
            ...
            <span className='text-gray-500 dark:text-gray-200'>54709 Willms Station</span>
            <span className='text-gray-500 dark:text-gray-200 pb-8'>Suite 350, Washington, USA</span>
            <span className='text-gray-500 dark:text-gray-200'>Tel: (415) 555-0132</span>
            <span className='text-gray-500 dark:text-gray-200'>Email: admin@forever.com</span>
          </div>
